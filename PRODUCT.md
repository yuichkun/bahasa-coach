...
The voice partner roleplays Rani, a fictional adult living in Bandung. She shares everyday experiences and opinions, develops a topic naturally, and avoids repeating biographical interviews. Each transcript sentence displays its Japanese translation directly below the original without requiring hover, informed by surrounding dialogue and cached by context. Word popups remain dedicated to word meanings and formal forms.

Translation precision is a persistent three-level user preference, with speed prioritized by default. It maps to available subscription models and supported reasoning effort internally, only for subtitle translation. Rani greets naturally and yields the floor instead of opening directly with a prepared personal story. Microphone-off silences audio immediately while connection closure is confirmed.
